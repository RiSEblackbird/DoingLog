...
RSpec.describe User, type: :model do
  ...
  it "失敗例：既存ユーザーで使用されているemailを登録する" do
    User.create(
      username: "KONO",
      profile: "国王",
      email: "TARO@mail.com",
  ...
  it "失敗例：必須入力項目(username)の未入力" do
    user = User.new(
      username: nil,
      profile: "関白",
      email: "AAA@mail.com",
  ...
  it "失敗例：必須入力項目(password))の未入力" do
    user = User.new(
      username: "魚雷",
      profile: "関白",
      email: "AAA@gmail.com",
